...
public class TestUriTemplate extends RestFlowTestCase {
...
public void testReduceTemplateAndExtractVariables_PathHasEmptyVariableBraces() {
	...
	public void testGetExpandedUri_NoScheme_NoPrefix_NoSuffix() throws Exception {
		...
		t1 = new UriTemplate("/");
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("/"), t1.getExpandedUri(nameValueMap, values, "", ""));
		
		t1 = new UriTemplate("/foo");
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("/foo"), t1.getExpandedUri(nameValueMap, values, "", ""));

		t1 = new UriTemplate("/foo/bar");
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("/foo/bar"), t1.getExpandedUri(nameValueMap, values, "", ""));

		t1 = new UriTemplate("/1/2/{v1}/bar");
		values = new Object[1];
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v1","valueOne");
		assertEquals(new Uri("/1/2/valueOne/bar"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("/1/2/valueOne/bar/valueTwo"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("/1/2/valueTwobarvalueOne"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueTwo", values[0]);
		assertEquals("valueOne", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("/1/2/valueOnevalueTwo"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap.put("v2","valueTwo");
		nameValueMap.put("v3","valueThree");
		assertEquals(new Uri("/1/2/valueOnevalueThree/3/valueTwo"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueThree", values[1]);
		assertEquals("valueTwo", values[2]);	
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v1","valueOne");
		assertEquals(new Uri("/1/2/valueOne/bar/valueOne"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueOne", values[1]);
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("/1/2/valueTwobarvalueTwo"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueTwo", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v3","valueThree");
		assertEquals(new Uri("/1/2/valueThreevalueThree"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueThree", values[0]);
		assertEquals("valueThree", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("/1/2/valueOnevalueTwo/3/valueOne"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		assertEquals("valueOne", values[2]);	
	}
	...
	public void testGetExpandedUri_NoPrefix_NoSuffix() throws Exception {
		...
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("data:/foo"), t1.getExpandedUri(nameValueMap, values, "", ""));

		t1 = new UriTemplate("file:/foo/bar");
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("file:/foo/bar"), t1.getExpandedUri(nameValueMap, values, "", ""));

		t1 = new UriTemplate("foo:/1/2/{v1}/bar");
		values = new Object[1];
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v1","valueOne");
		assertEquals(new Uri("foo:/1/2/valueOne/bar"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("data:/1/2/valueOne/bar/valueTwo"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("file:/1/2/valueTwobarvalueOne"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueTwo", values[0]);
		assertEquals("valueOne", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("foo:/1/2/valueOnevalueTwo"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap.put("v2","valueTwo");
		nameValueMap.put("v3","valueThree");
		assertEquals(new Uri("bar:/1/2/valueOnevalueThree/3/valueTwo"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueThree", values[1]);
		assertEquals("valueTwo", values[2]);	
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v1","valueOne");
		assertEquals(new Uri("foo:/1/2/valueOne/bar/valueOne"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueOne", values[1]);
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("foo:/1/2/valueTwobarvalueTwo"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueTwo", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v3","valueThree");
		assertEquals(new Uri("data:/1/2/valueThreevalueThree"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueThree", values[0]);
		assertEquals("valueThree", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("file:/1/2/valueOnevalueTwo/3/valueOne"), t1.getExpandedUri(nameValueMap, values, "", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		assertEquals("valueOne", values[2]);	
	}
	...
	public void testGetExpandedUri_NoSuffix() throws Exception {
		...
		t1 = new UriTemplate("foo:/");
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("foo:one.two/"), t1.getExpandedUri(nameValueMap, values, "one.two", ""));
		
		t1 = new UriTemplate("data:/foo");
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("data:three.four.five/foo"), t1.getExpandedUri(nameValueMap, values, "three.four.five", ""));

		t1 = new UriTemplate("file:/foo/bar");
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("file:one/foo/bar"), t1.getExpandedUri(nameValueMap, values, "one", ""));

		t1 = new UriTemplate("foo:/1/2/{v1}/bar");
		values = new Object[1];
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v1","valueOne");
		assertEquals(new Uri("foo:one.two.three/1/2/valueOne/bar"), t1.getExpandedUri(nameValueMap, values, "one.two.three", ""));
		assertEquals("valueOne", values[0]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("data:four.five/1/2/valueOne/bar/valueTwo"), t1.getExpandedUri(nameValueMap, values, "four.five", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("file:a.b.c/1/2/valueTwobarvalueOne"), t1.getExpandedUri(nameValueMap, values, "a.b.c", ""));
		assertEquals("valueTwo", values[0]);
		assertEquals("valueOne", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("foo:foo.bar/1/2/valueOnevalueTwo"), t1.getExpandedUri(nameValueMap, values, "foo.bar", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap.put("v2","valueTwo");
		nameValueMap.put("v3","valueThree");
		assertEquals(new Uri("bar:one.two/1/2/valueOnevalueThree/3/valueTwo"), t1.getExpandedUri(nameValueMap, values, "one.two", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueThree", values[1]);
		assertEquals("valueTwo", values[2]);	
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v1","valueOne");
		assertEquals(new Uri("foo:a.b.c/1/2/valueOne/bar/valueOne"), t1.getExpandedUri(nameValueMap, values, "a.b.c", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueOne", values[1]);
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("foo:foo-bar/1/2/valueTwobarvalueTwo"), t1.getExpandedUri(nameValueMap, values, "foo-bar", ""));
		assertEquals("valueTwo", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v3","valueThree");
		assertEquals(new Uri("data:a.1.b/1/2/valueThreevalueThree"), t1.getExpandedUri(nameValueMap, values, "a.1.b", ""));
		assertEquals("valueThree", values[0]);
		assertEquals("valueThree", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("file:1.2.c/1/2/valueOnevalueTwo/3/valueOne"), t1.getExpandedUri(nameValueMap, values, "1.2.c", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		assertEquals("valueOne", values[2]);	
	}
	...
	public void testGetExpandedUri_NoScheme_NoSuffix() throws Exception {
		...
		t1 = new UriTemplate("/");
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("one.two/"), t1.getExpandedUri(nameValueMap, values, "one.two", ""));
		
		t1 = new UriTemplate("/foo");
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("three.four.five/foo"), t1.getExpandedUri(nameValueMap, values, "three.four.five", ""));

		t1 = new UriTemplate("/foo/bar");
		nameValueMap = new HashMap<String,Object>();
		assertEquals(new Uri("one/foo/bar"), t1.getExpandedUri(nameValueMap, values, "one", ""));

		t1 = new UriTemplate("/1/2/{v1}/bar");
		values = new Object[1];
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v1","valueOne");
		assertEquals(new Uri("one.two.three/1/2/valueOne/bar"), t1.getExpandedUri(nameValueMap, values, "one.two.three", ""));
		assertEquals("valueOne", values[0]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("four.five/1/2/valueOne/bar/valueTwo"), t1.getExpandedUri(nameValueMap, values, "four.five", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("a.b.c/1/2/valueTwobarvalueOne"), t1.getExpandedUri(nameValueMap, values, "a.b.c", ""));
		assertEquals("valueTwo", values[0]);
		assertEquals("valueOne", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("foo.bar/1/2/valueOnevalueTwo"), t1.getExpandedUri(nameValueMap, values, "foo.bar", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap.put("v2","valueTwo");
		nameValueMap.put("v3","valueThree");
		assertEquals(new Uri("one.two/1/2/valueOnevalueThree/3/valueTwo"), t1.getExpandedUri(nameValueMap, values, "one.two", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueThree", values[1]);
		assertEquals("valueTwo", values[2]);	
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v1","valueOne");
		assertEquals(new Uri("a.b.c/1/2/valueOne/bar/valueOne"), t1.getExpandedUri(nameValueMap, values, "a.b.c", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueOne", values[1]);
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("foo-bar/1/2/valueTwobarvalueTwo"), t1.getExpandedUri(nameValueMap, values, "foo-bar", ""));
		assertEquals("valueTwo", values[0]);
		assertEquals("valueTwo", values[1]);
		...
		nameValueMap = new HashMap<String,Object>();
		nameValueMap.put("v3","valueThree");
		assertEquals(new Uri("a.1.b/1/2/valueThreevalueThree"), t1.getExpandedUri(nameValueMap, values, "a.1.b", ""));
		assertEquals("valueThree", values[0]);
		assertEquals("valueThree", values[1]);
		...
		nameValueMap.put("v1","valueOne");
		nameValueMap.put("v2","valueTwo");
		assertEquals(new Uri("1.2.c/1/2/valueOnevalueTwo/3/valueOne"), t1.getExpandedUri(nameValueMap, values, "1.2.c", ""));
		assertEquals("valueOne", values[0]);
		assertEquals("valueTwo", values[1]);
		assertEquals("valueOne", values[2]);	
	}
