 ...
 */
@ThreadSafe()
public class ClasspathProtocol extends AbstractProtocol implements ApplicationContextAware {

	private volatile WorkflowContext _workflowContext;
	...
	public Object loadResourcePayload(PublishedResource resource, Actor actor, String label) throws Exception {
		...
		Resource r = _workflowContext.getResource("classpath:" + relativePath);
